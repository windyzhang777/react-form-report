...
const ViewSnapshotData = ({
  ...
  const initialValues: IEditSdrValues = useMemo(
    () => ({
      ...
      EngineDetails: {
        EngineManufacturerName: snapshotData?.EngineManufacturerName || "",
        EngineModel: snapshotData?.EngineModel || "",
        EngineSerialNumber: snapshotData?.EngineSerialNumber || "",
        EngineTotalCycles: snapshotData?.EngineTotalCycles || "",
        EngineTotalTime: snapshotData?.EngineTotalTime || "",
      },
      ...
      PartDetails: {
        ...
        PartManufacturerName: snapshotData?.PartManufacturerName || "",
        PartManufacturerPartNumber: "",
        PartName: snapshotData?.PartName || "",
        PartType: snapshotData?.PartType || "",
      },
      ...
      ComponentDetails: {
        ComponentName: snapshotData?.ComponentName || "",
        ManufacturerName: snapshotData?.ComponentManufacturerName || "",
        PartNumber: snapshotData?.ComponentPartNumber || "",
        SerialNumber: snapshotData?.ComponentSerialNumber || "",
        ModelNumber: snapshotData?.ComponentModelNumber || "",
        ComponentLocation: snapshotData?.ComponentLocation || "",
        ComponentTotalTime: snapshotData?.ComponentTotalTime || "",
        ComponentTotalCycles: snapshotData?.ComponentTotalCycles || "",
        ComponentTimeSince: snapshotData?.ComponentTimeSince || "",
        ComponentTimeSinceCode: snapshotData?.ComponentTimeSinceCode || "",
      },
      LocationDetails: {
        ZoneId: 0,
